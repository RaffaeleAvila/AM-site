...
export default function Footer() {
  ...
  const clinics = [
    { name: 'Image Regenerative Clinic', location: 'Milano' },
    { name: 'YouMedical', location: 'Seregno' }
  ];

  return (
    <footer id="contatti" className="bg-gradient-to-br from-brand-blue to-brand-blue/90 text-white relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-0 left-0 w-64 h-64 bg-brand-gold rounded-full -translate-x-32 -translate-y-32"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              <img src={logo} alt="Logo Dottoressa Miegge" className="h-12 w-auto mr-3" />
              <div>
                <h3 className="font-serif text-xl font-bold">Dott.ssa Alice Miegge</h3>
                <p className="text-sm opacity-80">Medicina e Chirurgia Estetica</p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white bg-opacity-10 rounded-full flex items-center justify-center hover:bg-opacity-20 transition-all duration-300 transform hover:scale-110">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif text-lg font-semibold mb-6">Navigazione</h4>
          ...
          {/* Treatments */}
          <div>
            <h4 className="font-serif text-lg font-semibold mb-6">Trattamenti</h4>
            <ul className="space-y-3">
